...
class CameraManager {
  constructor() {
    ...
    this.setFacingMode = this.setFacingMode.bind(this);
  }
  ...
  /**
   * Set desired facing mode before starting the camera
  ...
  setFacingMode(facingMode) {
    ...
    this.facingMode = facingMode; // legacy field, kept in sync
    this.state.facingMode = facingMode;
    // Intentionally do not restart here; caller controls lifecycle
    this.notifyListeners('facingModeSet', { facingMode });
  }
