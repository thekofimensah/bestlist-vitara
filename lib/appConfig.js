...
export const appConfig = {
  // App branding
  name: "breadcrumbs", // Change this to your final app name
  displayName: "Breadcrumbs", // User-friendly display name
  
  // URL scheme for deep linking (should match your app name)
  urlScheme: "breadcrumbs", // Change this to match your app name
  
  // App store URLs (update these when you publish)
  appStoreUrl: "https://apps.apple.com/app/your-app-id", // iOS App Store
  playStoreUrl: "https://play.google.com/store/apps/details?id=com.test.bestlist", // Google Play Store
